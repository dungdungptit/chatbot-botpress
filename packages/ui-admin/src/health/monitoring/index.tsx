    ...
    return (
      <ResponsiveContainer height={300}>
        <ComposedChart data={this.state.preparedStats}>
          ...
          <Bar stackId="stack" yAxisId="l" name="Sự kiện vào" dataKey={`summary.${Metric.EventsIn}`} fill="#7E909A" />
          <Bar stackId="stack" yAxisId="l" name="Sự kiện ra" dataKey={`summary.${Metric.EventsOut}`} fill="#6AB187" />
          <Line
            yAxisId="r"
            name="Cảng báo"
      ...
      <div>
        <div className={style.row}>
          <div className={style.col}>
            <h5>CPU & Bộ nhớ (trung bình)</h5>
            {this.renderCpu()}
          </div>
          <div className={style.col}>
            <h5>Chỉ số (tổng cộng)</h5>
            {this.renderMeasures()}
          </div>
        </div>
