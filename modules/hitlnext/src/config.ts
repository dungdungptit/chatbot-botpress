export interface Config {
   ...
   * @default { "en": "You are being transferred to an agent.","vi": "Bạn đang được chuyển đến một agent.", "fr": "Vous êtes transféré à un agent.", "es": "Se le está transfiriendo a un agente."}
   */
  transferMessage: {
    [Key: string]: string
  }
   ...
   * @default { "en": "You have been assigned to our agent {{agentName}}.","vi": "Bạn đã được chỉ định cho agent của chúng tôi {{agentName}}.", "fr": "Vous avez été assigné à notre agent(e) {{agentName}}.", "es": "Ha sido asignado al agente {{agentName}}."}
   */
  assignMessage: {
    [Key: string]: string
  }
